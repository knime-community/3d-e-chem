...
public class WorkflowTest {
    ...
    @Test
    public void test_fragment_information_node() throws IOException, InvalidSettingsException, CanceledExecutionException,
            UnsupportedWorkflowVersionException, LockFailedException, InterruptedException {
        File workflowDir = new File("src/knime/kripo-fragment-information-test");
