...
public class FragmentByIdModel extends KripoNodeModel<FragmentsByIdConfig> {
	...
	protected DataTableSpec[] configure(final DataTableSpec[] inSpecs) throws InvalidSettingsException {
		...
		String fragmentsdb = config.getFragmentsDB().getStringValue();
		if ("".equals(fragmentsdb) || fragmentsdb == null) {
			throw new InvalidSettingsException("Fragments database file or ws url can not be empty");
		} else {
