...
public class FragmentsBySimilarityConfig extends PythonNodeConfig {
	...
	private static final String DEFAULT_MATRIX = "http://3d-e-chem.vu-compmedchem.nl/kripodb";
	private SettingsModelIntegerBounded m_limit = new SettingsModelIntegerBounded(CFG_LIMIT, DEFAULT_LIMIT, 0,
			Integer.MAX_VALUE);
