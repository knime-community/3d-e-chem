...
public class FragmentsApi {
     ...
     */
    public void getFragmentPhar(String fragmentId) throws ApiException {
        getFragmentPharWithHttpInfo(fragmentId);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> getFragmentPharWithHttpInfo(String fragmentId) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call getFragmentPharAsync(String fragmentId, final ApiCallback<Void> callback) throws ApiException {
